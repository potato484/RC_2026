...
- `src/rc26_xhu_viewer/rc26_xhu_viewer/viewer`
  - 读取 `rc26_xhu_viewer_server.py` 输出的 scene manifest、surface-route 回放、局部规划案例和 live 运行态
...
- `src/rc26_xhu_viewer/rc26_xhu_viewer/viewer` 是 R2 的本地 Web 可视化平台前端
...
- 改 `src/rc26_xhu_viewer/rc26_xhu_viewer/viewer/*` 或 `src/rc26_xhu_viewer/rc26_xhu_viewer/scripts/rc26_xhu_viewer_server.py` 时，优先同步 [visualization_viewer/README.md](visualization_viewer/README.md)
