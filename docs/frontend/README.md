...
- 改 `src/rc26_visualization/viewer/*` 或 `src/rc26_visualization/scripts/visualization_server.py` 时，优先同步 [visualization_viewer/README.md](visualization_viewer/README.md)
