...
VIEWER_DIR="$ROOT_DIR/src/rc26_xhu_viewer/rviz2/viewer"
PACKAGE_ROOT="$ROOT_DIR/release/rviz2_rc26_web"
ARCHIVE_PATH="$ROOT_DIR/release/rviz2_rc26_web.tgz"
SKIP_BUILD=0
...
Options:
  --skip-build   Reuse existing src/rc26_xhu_viewer/rviz2/viewer/dist.
...
cp "$ROOT_DIR/src/rc26_xhu_viewer/rviz2/scripts/rviz2_rc26_server.py" "$PACKAGE_ROOT/scripts/rviz2_rc26_server.py"
cp "$ROOT_DIR/src/rc26_xhu_viewer/rviz2/scripts/visualization_algorithms.py" "$PACKAGE_ROOT/scripts/visualization_algorithms.py"
cp "$ROOT_DIR/src/rc26_topo_nav/scripts/render_graph_sim_html.py" "$PACKAGE_ROOT/scripts/render_graph_sim_html.py"
cp -R "$ROOT_DIR/src/rc26_topo_nav/sim_assets" "$PACKAGE_ROOT/sim_assets"
cp "$ROOT_DIR/src/rc26_xhu_viewer/rviz2/config/field_scene_manifest.yaml" "$PACKAGE_ROOT/config/field_scene_manifest.yaml"
...
tar -czf "$ARCHIVE_PATH" -C "$ROOT_DIR/release" rviz2_rc26_web
