 ...
 * @Date: 2025-12-30 17:42:15
 * @LastEditors: potato potato@potato.com
 * @LastEditTime: 2025-12-31 14:47:11
 * @FilePath: /RC_2026/RC_2026_1/rc26_decision/src/gain_odom/pose_sender.cpp
 * @Description: 这是默认设置,请设置`customMade`, 打开koroFileHeader查看配置 进行设置: https://github.com/OBKoro1/koro1FileHeader/wiki/%E9%85%8D%E7%BD%AE
 */
#include "rc26_decision/gain_odom/pose_sender.hpp"
...
PoseSender::PoseSender(
    rclcpp::Node& node, std::shared_ptr<SerialDriver> serial_driver, Config config)
