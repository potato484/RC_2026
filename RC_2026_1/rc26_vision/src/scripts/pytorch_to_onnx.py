#!/usr/bin/env python3
#python3 RC_2026_1/rc26_vision/src/scripts/pytorch_to_onnx.py --checkpoint /path/to/best.pt --ultralytics --onnx /path/to/best.onnx --imgsz 640 --opset 17 --simplify
import argparse
import importlib
