// 达妙 DM-IMU-L1 六轴IMU协议定义 (基于说明书V1.2)
// USB通信 | 波特率：921600 | 校验：CRC16 | 字节序：小端
#pragma once
...
// 帧结构常量
// ============================================================================
constexpr uint8_t DM_FRAME_HEAD_0 = 0x55;
constexpr uint8_t DM_FRAME_HEAD_1 = 0xAA;
constexpr uint8_t DM_FRAME_TAIL = 0x0A;
constexpr size_t DM_FRAME_LEN = 19;
constexpr uint32_t DM_DEFAULT_BAUDRATE = 921600;
...
// CRC16 计算函数
// ============================================================================
inline uint16_t dm_crc16(const uint8_t* data, size_t len)
{
    uint16_t crc = 0xFFFF;
