...
bool rc26_perception__msg__block_detection__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rc26_perception.msg._block_detection.BlockDetection", full_classname_dest, 51) == 0);
  }
  rc26_perception__msg__BlockDetection * ros_message = _ros_message;
  {  // class_name
...
PyObject * rc26_perception__msg__block_detection__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("rc26_perception.msg._block_detection");
