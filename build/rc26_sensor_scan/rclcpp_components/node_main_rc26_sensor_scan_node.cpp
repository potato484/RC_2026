...
#define NODE_MAIN_LOGGER_NAME "rc26_sensor_scan_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "librc26_sensor_scan.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<rc26_sensor_scan::SensorScanNode>";
