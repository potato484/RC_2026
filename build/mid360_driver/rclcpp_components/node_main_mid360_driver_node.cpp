...
#define NODE_MAIN_LOGGER_NAME "mid360_driver_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libmid360_driver.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<mid360_driver::Mid360DriverNode>";
