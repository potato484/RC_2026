...
#define NODE_MAIN_LOGGER_NAME "rc26_localization_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "librc26_localization.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<rc26_localization::LocalizationNode>";
