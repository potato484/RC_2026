...
#define NODE_MAIN_LOGGER_NAME "rc26_odom_interface_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "librc26_odom_interface.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<rc26_odom_interface::OdomInterfaceNode>";
