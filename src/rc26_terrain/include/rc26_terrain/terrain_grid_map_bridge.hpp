...
private:
    ...
    void mfKfsStateCallback(const rc26_interfaces::msg::MfKfsState::ConstSharedPtr& msg);
    ...
    bool resolveLayoutPath(const std::string& raw_path, std::string& resolved_path) const;
    ...
    rclcpp::Subscription<rc26_interfaces::msg::MfKfsState>::SharedPtr sub_mf_kfs_state_;
