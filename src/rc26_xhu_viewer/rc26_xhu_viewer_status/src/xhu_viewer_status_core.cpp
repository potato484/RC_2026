...
XhuViewerStatusCore::XhuViewerStatusCore(XhuViewerStatusConfig config)
    : config_(std::move(config)) {}

void XhuViewerStatusCore::setConfig(const XhuViewerStatusConfig& config) {
  config_ = config;
}
...
XhuViewerStatusCore::Output XhuViewerStatusCore::evaluate(
