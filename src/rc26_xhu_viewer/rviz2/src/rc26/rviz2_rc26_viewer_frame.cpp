...
#include "rc26/rviz2_rc26_display_factory.hpp"

namespace rviz2_rc26
{

RViz2Rc26ViewerFrame::RViz2Rc26ViewerFrame(
...
void RViz2Rc26ViewerFrame::configureVisualizationManager()
{
  if (manager_) {
    manager_->setDisplayFactory(new RViz2Rc26DisplayFactory());
  }
}

void RViz2Rc26ViewerFrame::initMenus()
{
...
void RViz2Rc26ViewerFrame::initToolbars()
{
  QFont font;
