...
import { buildLiveEventsUrl } from './features/live/liveBridge';
import {
  accumulateExpandedEntries,
  accumulateOpenSetEntries,
  buildTraceNodePoseMap,
  hydratePlannerFrame,
} from './features/trace/traceModel';
import {
  buildPreviewSummary,
  formatElapsedMs,
  formatLevel,
  formatMetricValue,
  formatPlanningLogLevel,
  formatPose,
  formatPreviewResultLabel,
  formatSeverity,
  formatStringList,
  mergePlanningTiming,
  previewDisplayPath,
  previewDisplaySegments,
  resolveTimingMs,
} from './features/viewer/formatting';
import type {
  ExpandedNode,
            ...
            <div className="inspector-column">
              ...
              <section className="panel-section">
                ...
                <div className="trace-card">
                  ...
                  <div className="trace-meta">
                    <span>聚合 `/r2/xhu_viewer/events` 与 `/r2/bt/events` 的最近状态。</span>
                  </div>
