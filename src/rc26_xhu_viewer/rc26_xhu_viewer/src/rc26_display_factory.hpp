#ifndef RC26_XHU_VIEWER__RC26_DISPLAY_FACTORY_HPP_
#define RC26_XHU_VIEWER__RC26_DISPLAY_FACTORY_HPP_
...
class RC26DisplayFactory : public rviz_common::DisplayFactory
{
public:
  RC26DisplayFactory()
  : rviz_common::DisplayFactory()
  {
    allowed_ = {
      ...
      "rc26_xhu_viewer/LocalizationDisplay",
      "rc26_xhu_viewer/RegistrationDebugDisplay",
      "rc26_xhu_viewer/NavCandidatesDisplay",
      "rc26_xhu_viewer/DynamicPredictionDisplay",
      "rc26_xhu_viewer/TerrainSemanticDisplay",
    };
  }
    ...
    const QString & class_id, QString * error_return = nullptr) override
  {
    if (!allowed_.count(class_id.toStdString())) {
      RVIZ_COMMON_LOG_WARNING_STREAM(
        "RC26DisplayFactory: blocked non-allowlisted plugin '" <<
...
#endif  // RC26_XHU_VIEWER__RC26_DISPLAY_FACTORY_HPP_
