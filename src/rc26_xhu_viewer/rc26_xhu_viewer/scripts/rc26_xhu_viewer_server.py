...
def xhu_viewer_package_path(*parts: str) -> Path:
...
def default_field_scene_manifest_file() -> Path:
    return xhu_viewer_package_path("config", "field_scene_manifest.yaml")
...
if FRONTEND_DIST.is_dir():
    app.mount("/", StaticFiles(directory=FRONTEND_DIST, html=True), name="rc26-xhu-viewer-web")
