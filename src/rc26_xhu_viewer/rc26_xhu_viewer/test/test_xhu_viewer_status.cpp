...
TEST(XhuViewerStatusCoreTest, NominalCruiseStaysGreen) {
  XhuViewerStatusCore core;
...
TEST(XhuViewerStatusCoreTest, NearObstacleRaisesControllerAlert) {
  XhuViewerStatusCore core;
  std_msgs::msg::Header header;
...
TEST(XhuViewerStatusCoreTest, LocalPlannerRuntimeSignalsBecomeEvents) {
  XhuViewerStatusCore core;
  std_msgs::msg::Header header;
  auto input = makeNominalInput();
...
TEST(XhuViewerStatusCoreTest, KeepoutStaleTriggersRedEvent) {
  XhuViewerStatusCore core;
  std_msgs::msg::Header header;
  auto input = makeNominalInput();
...
TEST(XhuViewerStatusCoreTest, LocalizationOrControlDegradeIsDetected) {
  XhuViewerStatusCore core;
  std_msgs::msg::Header header;
  auto input = makeNominalInput();
...
TEST(XhuViewerStatusCoreTest, TimingNavMechanismAndTopicDetailsExposeEvidence) {
  XhuViewerStatusCore core;
  std_msgs::msg::Header header;
  auto input = makeNominalInput();
...
TEST(XhuViewerStatusCoreTest, DisabledSubsystemsExposeMetadataWithoutTriggeringFailures) {
  XhuViewerStatusConfig config;
  config.controller_present = false;
  config.keepout_present = false;
  config.nav_safety_present = false;
  config.terrain_present = false;

  XhuViewerStatusCore core(config);
  std_msgs::msg::Header header;
  header.stamp.sec = 55;
  auto input = makeNominalInput();
...
TEST(XhuViewerStatusCoreTest, EmptySourceSignalFallsBackToSystemInternal) {
  XhuViewerStatusConfig config;
...
TEST(XhuViewerStatusCoreTest, ExplicitUnknownSourceFallsBackToUnnamedModule) {
  XhuViewerStatusConfig config;
