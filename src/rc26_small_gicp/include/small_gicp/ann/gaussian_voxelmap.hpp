...
struct Traits<GaussianVoxel> {
    ...
    static size_t nearest_neighbor_search(const GaussianVoxel& voxel, const Eigen::Vector4d& pt, size_t* k_index,
                                          double* k_sq_dist) {
        *k_index = 0;
    ...
    static size_t knn_search(const GaussianVoxel& voxel, const Eigen::Vector4d& pt, size_t k, size_t* k_index,
                             double* k_sq_dist) {
