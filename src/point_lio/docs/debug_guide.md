...
colcon build --parallel-workers 1 --packages-select point_lio rc26_odom_interface rc26_sensor_scan rc26_lio_state_predictor rc26_bringup
```
...
**备注**：所有参数配置位于 `src/point_lio/config/mid360.yaml`。修改后无需重新编译，重启节点即可生效。
