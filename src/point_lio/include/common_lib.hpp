...
MTK_BUILD_MANIFOLD(state_input, ((vect3, pos))((SO3, rot))((SO3, offset_R_L_I))((vect3, offset_T_L_I))((vect3, vel))(
                                    (vect3, bg))((vect3, ba))((vect3, gravity)));

MTK_BUILD_MANIFOLD(state_output, ((vect3, pos))((SO3, rot))((SO3, offset_R_L_I))((vect3, offset_T_L_I))((vect3, vel))(
...
bool esti_plane(Matrix<T, 4, 1>& pca_result, const PointVector& point, const T& threshold) {
    ...
    T n = normvec.norm();
    const T kPlaneEps = static_cast<T>(1e-6);
    if (n < kPlaneEps) {
        return false;
    }
