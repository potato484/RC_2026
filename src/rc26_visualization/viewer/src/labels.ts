...
export const UI_LABELS = {
  appEyebrow: 'RC26 Visualization',
  appTitle: '全局比赛场地闭环可视化平台',
  appSubtitle: '统一消费 live 运行态、离线路线回放、行为树阶段、定位健康和机构状态，不再依赖 Foxglove。',
  routeTitle: '比赛场地三维总览',
  routeModeHint: '页面同时保留表面路线生成能力，并叠加运行态、阶段区和诊断信息。',
  statusWaiting: '正在加载比赛场地',
  statusLoaded: '场景已就绪，可切换布局并在场景里生成路线',
  statusError: '场景加载失败',
  panelLayout: '布局预设',
  panelView: '观测视角',
  panelLayers: '图层控制',
  ...
  panelTrace: '搜索回放',
  panelSegments: '路线分段',
  panelPlatformStatus: '平台状态',
  panelLiveRuntime: '运行时观测',
  panelEvents: '诊断事件',
  panelLocalPlannerTrace: '局部规划案例',
  ...
  btnLoadLocalPlannerTrace: '加载局部规划案例',
  btnClearRoute: '清空路线',
  fieldTeam: '阵营',
  ...
  fieldLayoutPreset: '当前布局',
  fieldActivePhase: '当前阶段区',
  fieldRobotPose: '机器人位姿',
  statFrame: '当前帧',
  statCost: '总代价',
  ...
  statExpanded: '已探查点',
  statEvents: '活跃事件',
  statKeepouts: 'Keepout',
  legendOpenSet: '蓝色圆点表示前沿点',
  legendOpenSetHint: '表示这些节点在本次搜索回放里曾进入待扩展队列；生成回放后会累计常显。',
  legendExpanded: '黄色方块表示已探查点',
  legendExpandedHint: '表示这些节点在本次搜索回放里曾被规划器取出并完成扩展；生成回放后会累计常显。',
  legendLayerHint: '对应顶部图层开关，工程布局下会打开更多调试图层。',
  legendPhaseZones: '半透明色块表示当前阶段区',
  legendPhaseZonesHint: '行为树快照会高亮当前 active subtree 对应的语义区域。',
  ...
  hintGenerate: '先生成表面路线；live 运行态和阶段区会在后台持续刷新。',
  ...
  hintLocalPlannerTrace: '用于离线查看局部规划候选轨迹与最终状态，不影响当前表面路线。',
  hintPlatformStatus: '该面板汇总控制、定位、机构和行为树当前快照。',
  hintEventsEmpty: '当前没有活动诊断事件。',
  emptyValue: '暂无',
  statusPending: '等待生成',
