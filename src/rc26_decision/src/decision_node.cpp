...
public:
    DecisionNode() : Node("rc26_decision") {
        ...
        this->declare_parameter<std::string>("localization_health_topic", "/localization/health");
        this->declare_parameter<std::string>("localization_backend_status_topic", "/localization/backend_status");
        this->declare_parameter<std::string>("localization_route_observability_topic",
        ...
        this->declare_parameter<std::vector<std::string>>("loc_retry_waypoints", std::vector<std::string>{"loc_retry_zone_1"});
        this->declare_parameter<std::vector<std::string>>("loc_anchor_waypoints",
        ...
        blackboard->set("loc_recommended_profile", this->get_parameter("loc_profile_normal").as_string());
        blackboard->set("loc_last_profile", this->get_parameter("loc_profile_normal").as_string());
        blackboard->set("loc_profile_normal", this->get_parameter("loc_profile_normal").as_string());
        blackboard->set("loc_profile_yellow", this->get_parameter("loc_profile_yellow").as_string());
        blackboard->set("loc_profile_orange", this->get_parameter("loc_profile_orange").as_string());
        blackboard->set("loc_profile_red", this->get_parameter("loc_profile_red").as_string());
        blackboard->set("loc_spin_action_name", this->get_parameter("loc_spin_action_name").as_string());
        blackboard->set("loc_spin_angle_deg", this->get_parameter("loc_spin_angle_deg").as_double());
        blackboard->set("loc_spin_time_allowance_sec",
                        this->get_parameter("loc_spin_time_allowance_sec").as_double());
        blackboard->set("loc_retry_waypoints", this->get_parameter("loc_retry_waypoints").as_string_array());
        blackboard->set("loc_anchor_waypoints", this->get_parameter("loc_anchor_waypoints").as_string_array());
        ...
        const auto loc_health_topic = this->get_parameter("localization_health_topic").as_string();
        localization_health_sub_ = this->create_subscription<rc26_interfaces::msg::LocalizationHealth>(
            ...
            [blackboard](const rc26_interfaces::msg::LocalizationHealth::SharedPtr msg) {
        ...
        const auto loc_backend_topic = this->get_parameter("localization_backend_status_topic").as_string();
        localization_backend_sub_ = this->create_subscription<rc26_interfaces::msg::LocalizationBackendStatus>(
            ...
            [blackboard](const rc26_interfaces::msg::LocalizationBackendStatus::SharedPtr msg) {
                blackboard->set("loc_graph_health", msg->graph_health);
                blackboard->set("loc_optimizer_ready", msg->optimizer_ready);
            });

        const auto loc_route_topic = this->get_parameter("localization_route_observability_topic").as_string();
        localization_route_sub_ = this->create_subscription<rc26_interfaces::msg::RouteObservability>(
            loc_route_topic, rclcpp::SensorDataQoS(),
            [blackboard](const rc26_interfaces::msg::RouteObservability::SharedPtr msg) {
                blackboard->set("loc_route_score", msg->score);
                blackboard->set("loc_route_risk_level", static_cast<int>(msg->risk_level));
                if (!msg->recommended_nav_profile.empty()) {
                    blackboard->set("loc_recommended_profile", msg->recommended_nav_profile);
                }
            });
...
private:
    ...
    rclcpp::Subscription<rc26_interfaces::msg::RouteObservability>::SharedPtr localization_route_sub_;
