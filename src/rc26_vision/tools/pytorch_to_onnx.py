...
# python3 ${RC26_WS}/src/rc26_vision/tools/pytorch_to_onnx.py --checkpoint ${RC26_WS}/src/rc26_vision/models/kfs.pt --ultralytics --onnx ${RC26_WS}/src/rc26_vision/models/kfs.onnx --imgsz 640 --opset 17 --simplify
import argparse
import importlib
