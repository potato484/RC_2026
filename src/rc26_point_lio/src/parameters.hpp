...
struct LioRuntimeState {
    ...
    bool experimental_loop_closure_enable = false;
    double experimental_loop_closure_frequency_hz = 0.5;
    double experimental_loop_closure_keyframe_dist_threshold_m = 1.0;
    double experimental_loop_closure_keyframe_angle_threshold_rad = 0.2;
    double experimental_loop_closure_search_radius_m = 15.0;
    double experimental_loop_closure_time_diff_threshold_sec = 30.0;
    int experimental_loop_closure_exclude_recent_keyframes = 30;
    double experimental_loop_closure_sc_dist_threshold = 0.20;
    double experimental_loop_closure_icp_fitness_threshold = 0.5;
    double experimental_loop_closure_icp_max_correspondence_dist_m = 100.0;
    int experimental_loop_closure_icp_max_iterations = 100;
    int experimental_loop_closure_submap_size = 25;
    double experimental_loop_closure_keyframe_cloud_voxel_size_m = 0.15;
    int experimental_loop_closure_max_keyframes_with_cloud = 500;
...
DECLARE_LIO_STATE_REF(experimental_loop_closure_enable);
DECLARE_LIO_STATE_REF(experimental_loop_closure_frequency_hz);
DECLARE_LIO_STATE_REF(experimental_loop_closure_keyframe_dist_threshold_m);
DECLARE_LIO_STATE_REF(experimental_loop_closure_keyframe_angle_threshold_rad);
DECLARE_LIO_STATE_REF(experimental_loop_closure_search_radius_m);
DECLARE_LIO_STATE_REF(experimental_loop_closure_time_diff_threshold_sec);
DECLARE_LIO_STATE_REF(experimental_loop_closure_exclude_recent_keyframes);
DECLARE_LIO_STATE_REF(experimental_loop_closure_sc_dist_threshold);
DECLARE_LIO_STATE_REF(experimental_loop_closure_icp_fitness_threshold);
DECLARE_LIO_STATE_REF(experimental_loop_closure_icp_max_correspondence_dist_m);
DECLARE_LIO_STATE_REF(experimental_loop_closure_icp_max_iterations);
DECLARE_LIO_STATE_REF(experimental_loop_closure_submap_size);
DECLARE_LIO_STATE_REF(experimental_loop_closure_keyframe_cloud_voxel_size_m);
DECLARE_LIO_STATE_REF(experimental_loop_closure_max_keyframes_with_cloud);
