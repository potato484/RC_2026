...
struct LioRuntimeState {
    ...
    bool adaptive_second_iter_enable = false;
    double adaptive_residual_thr = 0.08;
    double adaptive_omega_thr = 2.0;
    int adaptive_second_iter_max = 1;
    int lidar_type = 0;
...
DECLARE_LIO_STATE_REF(adaptive_second_iter_enable);
DECLARE_LIO_STATE_REF(adaptive_residual_thr);
DECLARE_LIO_STATE_REF(adaptive_omega_thr);
DECLARE_LIO_STATE_REF(adaptive_second_iter_max);
